import { Breadcrumbs, Button, Divider, Group, Stack, Title, Text, Space } from "@mantine/core";
                ...
                <Breadcrumbs>
                    {crumbs?.map((crumb, index) => {
                        if (typeof crumb === "string") {
                            ...
                            return <Text key={crumb[1]} variant="link"><Link style={{ color: "inherit" }} to={"/dashboard" + crumb[1]}>{crumb[0]}</Link></Text>
                        }
                    })}
                </Breadcrumbs>
            </Stack>
